    ...
    return ( 
        <div className='container'>
         <div className='row p-5 mt-5 mb-5'>
            <h1 className='fs-2 '> To create a ticket, select a relevant topic
            </h1>
            ...
            <div className='col-4 p-5 mt-5 mb-5'>
            <h4 > <i class="fa fa-bar-chart" aria-hidden="true"></i> Trading and Markets
            </h4><br/>
            ...
            <div className='col-4 p-5 mt-5 mb-5'> 
            <h4 > <i class="fa fa-credit-card-alt" aria-hidden="true"></i> Funds
            </h4><br/>
            ...
            <div className='col-4 p-5 mt-5 mb-5'>
            <h4 > <i class="fa-brands fa-intercom"></i> Console
            </h4><br/>
            ...
            <div className='col-4 p-5 mt-5 mb-5'>
            <h4 > <i class="fa-brands fa-gg-circle"></i> Coin
            </h4><br/>
